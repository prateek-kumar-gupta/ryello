        ...
        <div className="flex flex-col items-center gap-6 sm:flex-row sm:justify-between">
          ...
          <nav className="flex items-center gap-4 text-sm">
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded-md bg-[#25D366]/10 px-3 py-1.5 text-sm font-medium text-[#25D366] transition-colors hover:bg-[#25D366]/20"
            >
              {/* WhatsApp icon (inline SVG to avoid extra dependency) */}
              <svg
                className="size-4"
                viewBox="0 0 24 24"
                fill="currentColor"
